...
TASK:
The integral curve of an ordinary differential equation with separated variables y'x*cos(y)=2*ln(x) passes through the point M0(e; PI/2). Find the value of x such that y=0.
...
Завдання:
Інтегральна крива звичайного диференціального рівняння з розділеними змінними y'x*cos(y)=2*ln(x) проходить через точку M0(e; PI/2). Знайдіть x, при якому y=0.
