...
HINTS: Solve the task, take the example as a rough general guideline. Write the answer in a mathematical way, without much comments, just the solution. Also, make sure you provide the full entire solution. \cot is ctg or cotangent here.
```

Завдання:
Розв’язати диференційні рівняння вищих порядків:
$\displaystyle y''+4y=\cot2x$
