  ...
  public partial class FormRestore : Form
  {
    ...
    private void btnConfirm_Click(object sender, EventArgs e)
    {
      ...
      if (name.Length != 0 && email.Length != 0)
      {
          ...
          if (user.Email == email && user.Name == name)
          {
            ...
            try
            {
              ...
              if (result == DialogResult.OK)
              {
                ...
                {
                  System.Windows.MessageBox.Show("Тимчасовий пароль було надіслано на вашу електронну пошту!", "Увага", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        if (!isFinded)
        {
          errors.Add("Користувача з такими даними не знайдено. Спробуйте ще раз.");
        }
      }
      else
      {
